...
try:
    # Pydantic v1 import path
    from pydantic.generics import GenericModel  # type: ignore
except Exception:  # pragma: no cover
    # In pydantic v2, GenericModel is an alias of BaseModel; fall back cleanly
...
class PaginatedResponse(GenericModel, Generic[T]):
    """Paginated response wrapper used by tests and routers.
...
# Note: Removed duplicated legacy definitions at bottom to avoid confusion
