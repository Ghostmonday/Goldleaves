...
class UserAnalytics:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "pages_visited": List[Any](self.pages_visited),
            "features_used": List[Any](self.features_used),
            "session_duration": self.session_duration.total_seconds(),
            "activity_counts": Dict[str, Any](self.activity_counts),
            "daily_activity": Dict[str, Any](self.daily_activity)
        }
