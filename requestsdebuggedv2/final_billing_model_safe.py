...
from sqlalchemy import Column, String, Numeric, Integer, Index, ForeignKey
...
class BillingEvent(Base):
    ...
    resource_id = Column(String(64), nullable=True)  # String for mixed resource types
    quantity = Column(Numeric(12, 4), default=1.0)
    unit = Column(String(16), default="call")
    unit_cost_cents = Column(Integer, nullable=True)
    dimensions = Column(JSONB, default=dict)  # Safe callable default
